...
const PLACE_TYPES = [
  ...
  { id: "insurance", name: "Insurance agency", query: "insurance agency" },
  ...
  { id: "dentalclinics", name: "Dentist", query: "dentist" },
  ...
  { id: "realestate", name: "Real estate agency", query: "real estate agency" },
  { id: "propertymanagement", name: "Rental appartments", query: "apartment rental" },
  { id: "travel", name: "Travel agency", query: "travel agency" },
